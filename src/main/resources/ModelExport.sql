...
`lastModiFieddate` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
ALTER TABLE `points` ADD CONSTRAINT `ProductID` FOREIGN KEY (`ProjectID`) REFERENCES `product` (`ID`);
